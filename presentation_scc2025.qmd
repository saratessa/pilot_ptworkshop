...
Precision Teaching offers a measurement system that improves the decision making quality of practitioners

Studies suggest that Precision Teaching can effectively improve skill acquisition in children with autism, leading to better retention, endurance, stability, and generalization of learned skills <small> (Wolking, 1980; White 2000; Mannion, 2022; Martinho et al., 2022).</small>
...
::: notes
This visual is meant to show the gap in the research. What you’re looking at are search results from two databases. The yellow bars are guided notes or ASR (active student responding) and the green bars are frequency building.

‘A’ is the initial search. ‘B’ is when we narrow it to articles in college or university settings. And ‘C’ is when we add in the online component.

So you can see, as soon as we get to online instruction, there’s a huge drop-off.

since this search we have actually done screening across four data bases and found only 4 studies in total meeting criteria across both startles.

There’s a really clear gap in the research but You might wonder why this is a problem.
:::
...
So, given all of that, it’s probably conservative. But even so, at least 54% of pre-licensure BCBAs are doing their training online

and yet we have very little in the way of evidence-based instructional strategies designed specifically for that context.
:::
...
Research these strategies in the online context to Learn the independent and combined effects of these under-researched promising behavioral education strategies for online graduate programs 

demonstrate the use of a validated implementation science framework in the development of training programs for pre-licensure BCBA’s 

so that last piece ill talk about next, the implementation science framework.
:::
...
::: notes
This is the traditional way researchers evaluate a treatment package, this approach can tell you if this intervention package has an effect.

If were using our entry level training as an example the components that go into this are ASR/Guided notes, a one-page review each week, an application case study, and live coaching which includes frequency building activities.

But if we used this traditional approach to evaluate our workshop it would tell us whether or not it has an effect, but it will not tell us 1. Which components are making positive contributions to the outcome 2. Whether the inclusion of one component has an impact on another. 

its possible one component could drive the whole effect, and another can be removed for optimization, or the inclusion of one component influences the effectiveness of another. This all matters if we want our workshop to be easily scalable and easily adopted by online programs.
:::
...
::: notes
this is why we are using the multiphase optimization strategy (MOST)

preparation, optimization, evaluation stages with example activities you do in those stages listed

**Resource Management principle** tells us not to waste time, money, or participant effort, design with feasibility in mind.

**Continual Optimization principle** tells us to not stop at version one of the intervention, keep making it better.

its a balance of both, you can think of them as counterweights, that force you to have to design carefully.

\*those are two points that run throughout each stage and will be highlighted in this talk by demi

From a behavior analysts POV the instructional design and data based decision making will live in the preparation stage and then the optimization stage could be a component analysis study.
...
optimizing means achieving a balance of effectiveness against
...
The result is interventions that eliminate inactive and unnecessary components, are practical to implement, and offer a good value.
:::

## <small>**Our Research Line**</small>

::: center
![](outrschline.png){fig-align="center"}
:::
...
The optimization stage will be the work I conduct for my dissertation which will be a group design, a factorial experiment with the two factors being the ASR/guided notes and Live coaching/ frequency building intervention.

\
Following that work we will decide if this optimized intervention is expected to be sufficiently effective (see diamond) and if no follow resource management principle and go back in to preparation and if yes we will move on to evaluating 
:::
...
::: notes
The rest of this presentation is going to sit in the preparation stage of the MOST framework. I'll walk through the work we did at the outset (his included designing, sourcing, and adapting materials), then demi will walk through our pilot study data and how we've refined components as we prepare for our second pilot.
:::
...
We recruited 3 precision teachers who were trained and skilled but used PT at differtent levels / in different contexts.

One was a BCBA who wasn't charting daily in his practice but frequently worked in school on consult where he would incorporate the chart and teach staff to chart knows how to chart fluently and is trained in PT.

One was a PhD doing research in precision teaching

and one was a practitioner with 5+ years direct work precision teaching both school and clinc and coaches other precision teachers
...
• Descriptive level or what terminology was used, did the PT-ers make judgement on what changes they would program or do any prediction about how the program would progress based on the data they saw

Based on these verbal samples, we created a rubric to score participants within three ranges beginners (7-10 rubric score) intermediate (11-16 rubric score) and advanced (17-21 rubric score)
:::
...
::: notes
Our workshop was 100% remote, we used the LMS canvas as well as zoom video conferencing.

Each week participants logged onto their canvas course during baseline they logged on and took a weekly quiz

once they entered the workshop they logged on

watched a video lesson

charted with a case study data (application task)

and then they attended a scheduled zoom meeting where we went over a 1 page review of that weeks lesson and then did the frequency building activities
:::
...
![](designofworkshop.png){fig-align="center"}
...
::: notes
These are the guided notes they were mailed and they were also given a handful of daily per minute paper charts and a self addressed stamp for them to send the case study back to me after
:::
...
::: notes
Now, the case study I talked about earlier. This was an independent application task.

Participants were mailed blank standard celeration charts

each week of the workshop they were given data from a “case study client” participants were expected to graph this data on their own without feedback and we would score their completed chart with 5 weeks of data at the end of the study.

The idea was to create a structured form that would anchor the workshop, and try to have them apply the skills in context.

To create the data, I first consulted with two BCBAs who specialize in verbal behavior and created a hypothetical VB-MAPP. Using an AI model, I generated plausible datasets and then refined them with expert clinicians.
:::
...
:::: notes
::: center
For the live coaching sessions, we kept a really consistent structure each week. After participants had finished that week’s video lesson and quiz, we’d meet together.

I’d start by giving them a one-page review of the video, and then we’d do a quick Q&A where they could bring up any questions or things that weren’t clear.

From there, we moved into practice activities

using Melroe’s fluency training materials for chart-reading drills, and Brown’s *Precision Decisions* guide to work through decision-making frameworks. We practiced skills like see/say corrects over errors and see/say timing floors.

At the end of each session, I’d bring up a real chart donated by a clinician and precision teacher that they hadn’t seen before. Participants were asked to describe the learning picture, and I recorded and transcribed their responses. Those verbal descriptions were later scored using a rubric I developed from earlier pre-work analyzing how experienced precision teachers describe learning pictures.
:::
::::
...
::: notes
we used a Multiple Baseline Design
...
I'll pass it to demi to talk about our measures, data, and revisions
:::
...
<small>**Participant 1B:**</small>

::: center
![](scc1B.png){fig-align="center" width="463"}
:::

::: notes
**Corrects/Errors:**

Timings were one minute, and the participants were instructed to look at a scc with hypothetical data and say the number of corrects and errors. For participant 1B, there were 4 sessions, over 29 days. Session 1 shows 10 correct responses per minute, and 0 incorrects per minute. Session 2 took place approximately 2 weeks after the initial session, and showed elevated levels of correct responding at 40 per minute. Incorrect responses also elevated, to about 2 per minute, likely due to a long gap between timing 1 and 2. We think this, because in session 3, 1B maintained the same level of corrects per minute, while incorrects decreased. Time between sessions 2 and 3 was 1 week. Session 4, which took place about a week after session 3, the experimenters sliced up, meaning the participant was seeing correct dots and incorrect X’s with values up to 100. In session 4, there were 20 corrects per minute and 0 incorrects per minute.

**Common Floors:**

Timings were 1 minute, and the participants were instructed to look at a SCC with hypothetical data and say the common timing floor they see on the chart. For example, 1 min, 30s, 2 hours, reading the timing floors marked across the chart fluently. For Participant 1B, there were 4 sessions over 27 days. Session 1 shows 18 corrects per minute, and 5 incorrects per minute. Session 2 shows 29 corrects per minute and 0 incorrects per minute. Session 3 shows 19 corrects per minute and 0 incorrects per minute. Session 4 shows 29 corrects per minute and 0 incorrects per minute. Overall improvement was 97%.  
:::

## <small>Fluency</small>

<small>**Participant 2A:**</small>

::: center
![](updated%20chart.png){fig-align="center" width="444"}
:::

::: notes
**Corrects/Errors:**

For participant 2A, there were 5 sessions across 27 days. Session 1 shows 25 corrects per minute and 0 incorrects per minute. Session 2 shows 31 corrects per minute and 3 incorrects per minute. Session 3 shows 19 corrects per minute and 4 incorrects per minute. Session 4 shows 21 corrects per minute and 1 incorrect per minute. Session 5 shows 31 corrects per minute and 2 incorrects per minute.

**Common floors:**

There were 5 sessions across 27 days. Session 1 shows 15 corrects per minute and 3 incorrects per minute. Session 2 shows 20 corrects per minute and 1 incorrect per minute. Session 3 shows 22 corrects per minute and 0 incorrects per minute. Session 4 shows 25 corrects per minute and 0 incorrects per minute. Session 5 shows 35 corrects per minute and 1 incorrect per min, with an overall improvement of 61%.
:::
...
::: center
![](SCC3A.png){fig-align="center" width="517"}
:::

::: notes
**Corrects/Errors:**

For participant 3A, there were 5 sessions across 28 days. Session 1 shows 30 corrects per minute and 0 incorrects per minute. After session 1, we sliced up to 0-100. Session 2 shows 30 corrects per minute and 0 incorrects per minute. Session 3 shows 20 corrects per minute and 0 incorrects per minute. Session 4 shows 20 incorrects per minute and 0 incorrects per minute. Session 5 shows 24 corrects per minute and 0 incorrects per minute. 

**Common Floors:**

There were 5 sessions across 28 days. Session 1 shows 20 correct responses per minute and 0 incorrects per minute. Session 2 shows 20 corrects per minute and 3 incorrects per minute. After session 2, there was a slice up to values 0-100. Session 3 shows 20 corrects per minute and 0 incorrects per minute. Session 4 31 corrects per min and 0 incorrects per min. Session 5 28 corrects per minute and 0 incorrects per minute. Overall 18% improvement.
:::
...
::: center
![](SCC3B.png){fig-align="center" width="478"}
:::

::: notes
**Corrects/ Incorrects:**

Participant 3B had 6 sessions across 28 days.  Session 1 shows 10 corrects per minute and 2 incorrects per minute. After session 2, there was a slice up to values 0-100. Session 2 shows 28 corrects per minute and 1 incorrect per minute. Session 3 shows 18 corrects per minute and 2 incorrect per minute. Session 4 shows 20 corrects per minute and 2 incorrects per minute. Session 5 shows 14 corrects per minute and 1 incorrect per minute. Session 6 shows 18 corrects per minute and 0 incorrects, with overall 13% improvement. 

**Common Floors:**

4 sessions across 28 days. Session 1 shows 6 correct responses per minute and 3 incorrect responses per minute. Session 2 shows 20 corrects per minute and 0 incorrects per minute. Session 3 shows 24 corrects per minute and 0 incorrect responses. Session 4 shows 29 corrects per minute and 0 incorrects per  minute, with over all 131% improvement.
:::
...
So no change was made to this measure in the second iteration.
:::
...
::: center
![](attempts_time.png){fig-align="center" width="555"}
:::
...
::: center
![](quality_grapj.png){fig-align="center" width="800"}
:::

::: notes
To improve performance on the weekly quiz measure, we made them untimed and one attempt, removed multiple choice questions, and on the weekly video lessons we added stronger examples of clinical data on the SCC with the instructor providing a verbal model of describing the learning picture on two charts per lesson.
:::
...
|  |
|------------------------------------------------------------------------|
| Following participation in our pilot study,all respondents rated the utility of key instructional components (live and recorded coaching, guided notes, and one-page review sheets )as positive on a 3-point scale (negative, neutral, positive). |
:::
...
::: notes
Participant feedback reflects strong endorsement across all domains, with predominantly positive ratings (green) for satisfaction, confidence, and real-world application of Precision Teaching methods. Most respondents reported discussing workshop content with peers and expressed high likelihood of recommending the series. Some exceptions include neutral ratings in participants’ confidence in applying what they learned over the course of the study, which suggests areas for refinement in the second phase of the study. 
:::

## Changes made? {.inverse background-color="#E0E0E0"}

::: center
![](no%20change.png){fig-align="center" width="687"}
:::
...
::: center
![](updatedslide.png){fig-align="center"}
:::
